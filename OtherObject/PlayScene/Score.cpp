...
Score::Score()
{
	...
	//テキストの初期化
	ARGUMENT_INITIALIZE(scoreText_[TennisCourtName::Z_MINUS_COURT].first, std::make_unique<Text>());
	ARGUMENT_INITIALIZE(scoreText_[TennisCourtName::Z_PLUS_COURT].first, std::make_unique<Text>());
